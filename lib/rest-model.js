 ...
 * @param {function} [cb] The callback function
 */
RestResource.prototype.create = function (obj, options, cb) {
  console.log({ obj, options, cb });
  ...
  this._request(
    this._req({
      headers: parseAuthHeaders(options, this.connector._settings),
      method: "POST",
      uri: this._url,
      json: true,
      body: obj,
 ...
 * @param {function} [cb] The callback function
 */
RestResource.prototype.update = function (id, obj, options, cb) {
  console.log({ id, obj, options, cb });
  if (!cb && typeof options === 'function') {
    cb = options;
    options = {};
  }
 ...
 * @param {function} [cb] The callback function
 */
RestResource.prototype.find = function (id, options, cb) {
  console.log({ id, options, cb });
  if (!cb && typeof options === 'function') {
    cb = options;
    options = {};
 ...
 */
RestResource.prototype.all = RestResource.prototype.query = function (
  q,
  options,
  cb
) {
  console.log({
    ...
    options,
    cb,
    passAuthToken: this.connector._settings.passAuthToken,
  });

  if (!options && !cb && typeof q === 'function') {
    cb = q;
    q = {};
